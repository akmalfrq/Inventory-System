      ...
      <section class="invoice">
        <div class="row">
          <div class="offset-1 col-10">
            <img width="100%" src="<?php echo base_url('assets/img/laporan/kopsky.png'); ?>" class="rounded mx-auto d-block" alt="kop">
          </div>
          <!-- /.col -->
        </div>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="text-center mt-0">SMK ANGKASA 1 KALIJATI</div>
          </div>
          <!-- /.col -->
        </div>
